...
public class VentanaEstadoEnlace extends javax.swing.JFrame {
    ...
    //Metodos
    private void IngresoDeArista(int[][]tablaEstadoEnlace ){
    ...
    private int[][] TablaGeneralT(int routRaiz,int cantRouter){
        
        int tabla[][]=new int[cantRouter][4];
        for(int i=0;i<cantRouter;i++){
            tabla[i][0]=i;
            tabla[i][1]=1000;
            tabla[i][2]=-1;        
